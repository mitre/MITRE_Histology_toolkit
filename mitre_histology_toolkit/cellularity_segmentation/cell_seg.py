...
def get_tissues(filepath, MAG=3.0, compactness=0.1, spixel_size_baseMag=64 * 64, max_cellularity=40,
               ...
               use_rgb = False, anno_dir = 'tmp', image_name = 'tmp'):
    """Detect tissues
    ...
    cds = cellularity_detection_superpixels.Cellularity_detector_superpixels(
        img,
        ...
        anno_dir = anno_dir, image_name = image_name,
...
def rescale_mask(tissues):
    ...
    for tissue_piece in tissues['tissue_pieces']:
